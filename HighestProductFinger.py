...
def mulAll():
    ...
    for r in range(0,MatrixSize):
        for c in range(0,MatrixSize):
            ...
            allList.append([cellList[index], direction])
...
someWierdInput = "08 02 22 97 38 15 00 40 00 75 04 05 07 78 52 12 50 77 91 08\n"
...
someWierdInput +="22 31 16 71 51 67 63 89 41 92 36 54 22 40 40 28 66 33 13 80\n"
someWierdInput +="24 47 32 60 99 03 45 02 44 75 33 53 78 36 84 20 35 17 12 50\n"
someWierdInput +="32 98 81 28 64 23 67 10 26 38 40 67 59 54 70 66 18 38 64 70\n"
someWierdInput +="67 26 20 68 02 62 12 20 95 63 94 39 63 08 40 91 66 49 94 21\n"
...
someWierdInput +="04 52 08 83 97 35 99 16 07 97 57 32 16 26 26 79 99 27 98 66\n"
someWierdInput +="88 36 68 87 57 62 20 72 03 46 33 67 46 55 12 32 99 93 53 69\n"
someWierdInput +="04 42 16 73 38 25 39 11 24 94 72 18 08 46 29 32 99 62 76 36\n"
...
list = mulAll()
list.sort(key=lambda x: x[0])  #the highest list is: [70600674, 'leftDown'], [70600674, 'rightUp']

print(list)

#index = list.index([70600674, 'rightUp'])
#print('The index of the highest product in list is: ',index)  #303 , #246
